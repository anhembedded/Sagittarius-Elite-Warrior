...
- ~~**BOT-023 — Dynamic Backtest Engine**~~ — **ĐÃ HUỶ (2026-08-18)**, xem [hồ sơ huỷ](../Tasks/cancelled/BOT-023_dynamic_backtest_engine.md). User story gốc: *Là người muốn "xem lại" thị trường như đang chạy thật, tôi muốn 1 Paper Exchange + Virtual Event Loop replay từng nến, có thể tua nhanh/chậm/tạm dừng...* — nhu cầu **replay để xem** vẫn còn giá trị, nhưng nó là lớp trình bày nên đã chuyển vào [`BOT-076`](../Tasks/completed/BOT-076_realtime_backtest_engine.md) §3.5 thay vì làm engine backtest thứ ba.
