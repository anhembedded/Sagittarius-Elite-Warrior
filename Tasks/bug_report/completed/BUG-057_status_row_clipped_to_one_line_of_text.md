...
**Phát hiện:** 2026-08-26, trong lúc làm [`EPIC-007F`](../../epics/EPIC-007_chuan_hoa_card_dung_chung/completed/EPIC-007F_migrate_4_man_hinh.md) — **không phải user báo**; lộ ra khi chụp ảnh trước/sau theo đúng yêu cầu "bằng chứng phải nộp" của task đó
