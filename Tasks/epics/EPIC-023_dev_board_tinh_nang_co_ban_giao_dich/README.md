...
- **Trạng thái:** 🟡 Đang làm (1/4 task con)
- **Repo:** Elite
...
| **B** | [Biểu đồ Vốn (equity) trên Dev Board](incomplete/EPIC-023B_bieu_do_von_realtime.md) | — | 🔴 |
| **C** | [Card "Chiến lược" thật — Nạp/Gỡ + Tín hiệu gần nhất](incomplete/EPIC-023C_card_chien_luoc_that_va_tin_hieu.md) | A (đọc cùng `_active_symbol`) | 🔴 |
